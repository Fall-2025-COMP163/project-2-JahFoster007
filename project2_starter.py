...
class Character:
    ...
    def take_damage(self, damage):
        ...
        if self.health < 0:
            self.health = 0
        print(f"{self.name} now has {self.health} HP left.")
...
class Warrior(Player):
    ...
    def attack(self, target):
        ...
        target.take_damage(damage)
        print(f"{self.name} swings a sword and deals {damage} damage!")
...
class Rogue(Player):
    ...
    def attack(self, target):
        ...
        if random.randint(1, 10) <= 3:
            damage *= 2
            print(f"{self.name} performs a CRITICAL HIT!")
        target.take_damage(damage)
        print(f"{self.name} attacks {target.name} for {damage} damage!")
    ...
    def sneak_attack(self, target):
        ...
        target.take_damage(damage)
        print(f"{self.name} performs BACKSTAB for {damage} damage!")
